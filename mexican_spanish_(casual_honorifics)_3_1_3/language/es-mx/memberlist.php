...
$lang = array_merge($lang, array(
	...
	'FIND_USERNAME_EXPLAIN'	=> 'Usa este formulario para buscar usuarios específicos. No necesita rellenar todos los campos. Para indicar datos parciales usa * como comodín. Cuando introduzcas fechas, usa el formato <kbd>YYYY-MM-DD</kbd>, p.ej. <samp>2004-02-29</samp>. Use los checkboxes para seleccionar uno o más usuarios (Se aceptan varios usuarios dependiendo del formulario en sí mismo) y clic en el botón Seleccionar Marcados para volver al formulario previo.',
	...
	'LOGIN_EXPLAIN_TEAM'		=> 'El administrador del Foro requiere que estés registrado y te hayas identificado para ver la lista del equipo.',
