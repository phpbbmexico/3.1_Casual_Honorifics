...
$lang = array_merge($lang, array(
	...
	'CONFIRM_SEARCH_BACKEND'				=> '¿Estás seguro de que querer cambiar a un motor de búsqueda diferente? Después de cambiar debes crear un nuevo índice. Si no planeas volver al anterior, también puedes borrar tu índice para liberar recursos de sistema.',
	...
	'FULLTEXT_MYSQL_INCOMPATIBLE_DATABASE'	=> 'Texto completo solo puede usarse con MySQL4 y superiores.',
	...
	'FULLTEXT_MYSQL_MIN_SEARCH_CHARS_EXPLAIN'	=> 'Palabras con al menos esta cantidad de caracteres serán indexadas para futuras búsquedas. Tu o tu hospedaje solo podrán cambiar esta configuración al cambiar la configuración de MySQL.',
	'FULLTEXT_MYSQL_MAX_SEARCH_CHARS_EXPLAIN'	=> 'Palabras con no más de esta cantidad de caracteres serán indexadas para futuras búsquedas. Tu o tu hospedaje solo podrán cambiar esta configuración al cambiar la configuración de MySQL.',
	...
	'FULLTEXT_SPHINX_NO_CONFIG_DATA'		=> 'No esta definina la ruta de data del directorio sphink. 
Por favor, defina la ruta y presentar para generar el archivo de configuración.',
