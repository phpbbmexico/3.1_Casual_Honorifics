...
$lang = array_merge($lang, array(
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Esto hará al Foro inaccesible a los usuarios que no sean ni  administradores ni moderadores. Si quieres, también puedes introducir un breve mensaje (255 caracteres) para mostrar.',
	...
	'OVERRIDE_STYLE_EXPLAIN'		=> 'Reemplaza el estilo del usuario (e invitados) por el estilo por defecto.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_WARNING'		=> 'Ten en cuenta que el método de activación seleccionado actualmente requiere correos electrónicos para ser habilitados, se desactivará el registro de otra manera. Se recomienda seleccionar un método de activación diferente, o volver a activar los mensajes de correo electrónico.',
...
$lang = array_merge($lang, array(
	...
	'ACP_VC_EXT_GET_MORE'		=> 'Para plugins adicionales (y puede que mejores), visia la <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>base de datos de Extensiones de phpBB</strong></a>. Para más información sobre prevención de Spam en tu foro, visita la <a href="https://www.phpbb.com/go/anti-spam"><strong>Knowledge Base de phpBB</strong></a>.',
...
// Contact Settings
$lang = array_merge($lang, array(
 	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Aquí puedes habilitar y deshabilitar la página de contacto y también añadir un texto que será mostrado en la página.',
...
$lang = array_merge($lang, array(
	...
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Número de días que transcurrirán antes de eliminar automáticamente las notificaciones de lectura. Establece este valor en 0 para hacer notificaciones permanentes.',
...
// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBB soporta plugins de autentificación o módulos. Esto te permite determinar cómo se identifica a los usuarios cuando se conectan al Foro. Por defecto se proveen tres plugins; DB, LDAP, Apache y OAuth. No todos los métodos requieren información adicional, así que rellena solo los campos que sean relevantes para el método elegido.',

	'AUTH_METHOD'				=> 'Selecciona un método de autentificación',

	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'Debes proporcionar la clave y secreto de cada proveedor de servicios habilitado OAuth. Sólo uno fue proporcionado por un proveedor de servicios de OAuth.',
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Cada proveedor OAuth requiere un secreto y la clave única para identificarse con el servidor externo.<br />Estos deben ser suministrados por el servicio OAuth al registrar su sitio web, y deben introducirse exactamente como se lo proporcionarón.<br />Cualquier servicio que no tenga su clave y su secreto introducido aquí, no estará disponible para los usuarios del foro.',
	'AUTH_PROVIDER_OAUTH_KEY'					=> 'Clave',
	'AUTH_PROVIDER_OAUTH_TITLE'					=> 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'				=> 'Secreto',

	'APACHE_SETUP_BEFORE_USE'	=> 'Tienes que configurar la autentificación de Apache antes de cambiar a este método. Ten en cuenta que el nombre de usuario que emplea para autentificación de Apache tiene que ser el mismo que usa en phpBB.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Determina si a los usuarios se les da la opción "Recordar" cuando visitan el foro.',
	'ALLOW_PASSWORD_RESET'			=> 'Permitir reinicio de contraseña ("Olvidé mi contraseña")',
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Determina si el usuario puede usar el enlace "Olvidé mi contraseña" de la página de inicio de sesión`para recordar su cuenta. Si utilizas un mecanismo de autenticación externo es posible que desees desactivar esta función.',
	...
	'IP_LOGIN_LIMIT_USE_FORWARDED_EXPLAIN'	=> 'En lugar de limitar los intentos de conexión por dirección IP que están limitados por los valores <var>X_FORWARDED_FOR</var>. <br /><em><strong>Aviso:</strong> Sólo habilita esta opción si estás funcionando en un servidor proxy que establece valores de confianza <var> X_FORWARDED_FOR </var>.</em>',
	...
	'REFERRER_VALID'					=> 'Validar Referer',
	'REFERRER_VALID_EXPLAIN'			=> 'Si está habilitado, el referer de peticiones de POST será comparado con la configuración existente de la ruta del host/script. Esto puede causar contingencias en foros que usen varios dominios y/o identificaciones externas.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> 'Este es el nombre del contacto que los destinatarios de correo electrónico van a ver. Si no quieres tener un nombre de contacto, deja este campo vacío.',
...
$lang = array_merge($lang, array(
	...
	'JAB_GTALK_NOTE'				=> 'Por favor observa que el GTalk no funcionará porque no se encontró la función <samp>dns_get_record</samp>. Esta función no está disponible en PHP4, y no está implementada en plataformas Windows. Actualmente no funciona en sistemas basados en BSD, incluído Mac OS.',
