...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'Al ingresar en "%1$s" (de aquí en adelante "nosotros", "nos", "nuestro", "%1$s", "%2$s"), Tu acuerdas estar legalmente sometido a los siguientes términos. En caso contrario por favor no se registre y/o use "%1$s". Podemos cambiar estos términos en cualquier momento e intentaríamos avisarle, sin embargo sería prudente que los revisase por tu cuenta periódicamente. Seguir registrado a "%1$s" después de esos cambios significa que acuerdas estar legalmente sometido a esos nuevos términos tal como fueron actualizados y/o reformados.<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'ATTACHMENTS_EXPLAIN'			=> 'Esta es una lista de adjuntos que has publicado en este foro.',
	...
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Tu puedes elegir tu avatar de un conjunto de avatares disponibles a nivel local.',
	...
	'BOOKMARKS'						=> 'Favoritos',
	'BOOKMARKS_EXPLAIN'				=> 'Puedes añadir temas a Favoritos para futuras consultas. Selecciona el checkbox para el Favorito que quieras borrar, luego has clic en el botón <em>Eliminar Favoritos marcados</em>.',
	...
	'CONFIRM_EXPLAIN'				=> 'Para prevenir registros automáticos el administrador del Sitio requiere que introduzca un código de confirmación. El código se muestra en la imagen que debería ver debajo. Si estás visualmente impedido o no puede ver el código, por favor contacte con el %sAdministrador del Sitio%s.',
	...
	'CURRENT_PASSWORD_EXPLAIN'		=> 'Tiene que confirmar tu contraseña actual si quieres editar tu dirección de email o nombre de usuario.',
	...
	'DELETE_RULE_CONFIRM'			=> '¿Estás seguro de queere borrar esta regla?',
	...
	'FORCE_PASSWORD_EXPLAIN'		=> 'Antes de continuar navegando por el Foro se requiere que cambie su contraseña',
	...
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Especifica el ancho y la altura del avatar, o dejelo en blanco para tratar de verificarlo automáticamente.',
	...
	'LINK_REMOTE_SIZE_EXPLAIN'		=> 'Especifica el ancho y alto del avatar, déjelo en blanco para intentar una verificación automática.',
	'LOGIN_EXPLAIN_UCP'				=> 'Por favor identifíca para acceder al Panel de Control de Usuario',
	'LOGIN_LINK'					=> 'Enlace o registra tu cuenta en un servicio externo con tu cuenta del foro',
	'LOGIN_LINK_EXPLAIN'			=> 'has intentado iniciar sesión con un servicio externo que aún no está conectado a una cuenta en este foro. Ahora debes vincular esta cuenta a una cuenta existente, o crear una nueva cuenta.',
	...
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'No se han facilitado datos a esta página para enlazar una cuenta externa a una cuenta del foro. Por favor, pónte en contacto con el Administrador del foro, si sigues teniendo problemas.',
	'LOGIN_KEY'						=> 'Clave de identificación',
	'LOGIN_TIME'					=> 'Fecha de identificación',
	'LOGIN_REDIRECT'				=> 'Te has identificado correctamente.',
	'LOGOUT_FAILED'					=> 'No has sido desconectado, la petición no coincide con tu sesión. Por favor contacte con el administrador del foro si continúas experimentando problemas.',
	...
	'NEW_PASSWORD_CONFIRM_EMPTY'	=> 'Tu no has ingresado la confirmación de contraseña.',
	...
	'NOT_ADDED_FOES_SELF'			=> 'No puedes añadirse a tu lista de ignorados.',
	...
	'NO_AVATAR'						=> 'No seleccionaste avatar',
	...
	'NO_AUTH_PROFILEINFO'			=> 'No estás autorizado a cambiar la información de su perfil.',
	...
	'PROFILE_INFO_NOTICE'	=> 'Por favor ten en cuenta que esta información será vista por otros usuarios. Debes ser cuidadoso cuando incluyas detalles personales. Los campos marcados con * deben completarse obligatoriamente.',
	'PROFILE_UPDATED'		=> 'Tu perfil ha sido actualizado.',
	'PROFILE_AUTOLOGIN_KEYS'	=> 'Las claves de acceso "Recordar" permite que te conectes automáticamente cuando visites el foro. Si cierras la sesión, el recuerdo de clave se elimina sólo en el equipo que se utiliza para cerrar la sesión. Aquí puedes ver claves de acceso creadas en otros equipos que utilizas para acceder a este sitio.',
	...
	'SELECT_TIMEZONE'			=> 'Seleccione tu zona horaria',
	'SORT'						=> 'Ordenar',
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Por favor, observe que necesitas introducir una dirección de email válida antes de que tu cuenta sea activada. El Administrador revisará tu cuenta y si la aprueba, recibirá un email en la direccion que introdujiste.',
	'UCP_ATTACHMENTS'			=> 'Adjuntos',
	'UCP_AUTH_LINK'				=> 'Cuentas externas',
	'UCP_AUTH_LINK_ASK'			=> 'Actualmente no tienes una cuenta asociada a este servicio externo. Has clic en el botón de abajo para enlazar tu cuenta del foro a una cuenta con este servicio externo.',
	...
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Aquí puedes ajustar sus métodos de Notificación preferidas para el foro.',
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'La funcionalidad de restablecimiento de contraseña ha sido desactivada. Si necesitas ayuda para acceder a tu cuenta, por favor pónte en contacto con el %sAdministrador del Foro%s',
	...
	'USERNAME_DISALLOWED_USERNAME'	=> 'El nombre de usuario que introdiste ha sido excluido.',
	...
	'WATCHED_EXPLAIN'	=> 'Debajo está la lista de foros y temas a los que estás suscrito. Será notificado de nuevos mensajes en ellos. Para cancelar la suscripción marca el foro o tema y luego haga clic en el botón <em>No seguir marcados</em>.',
	...
	'YOUR_FOES_EXPLAIN'		=> 'Para eliminar nombres de usuarios selecciónelos y luego has clic en Enviar',
