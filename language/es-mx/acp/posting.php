...
$lang = array_merge($lang, array(
	...
	'BBCODE_TAG_DEF_TOO_LONG'	=> 'La definición de etiqueta que introdujiste es muy larga, por favor acórtela.',
	...
	'HTML_REPLACEMENT_EXPLAIN'		=> 'Aquí defines el reemplazo HTML por defecto (cada plantilla puede tener su propio reemplazo HTML). ¡No olvides poner las marca claves que usaste arriba!!',
	...
	'TOO_MANY_BBCODES'		=> 'No puedes crear más BBCodes. Por favor borra uno o más BBCodes y luego inténtelo de nuevo.',
	...
	'tokens'	=>  array(
		...
		'LOCAL_URL'		=> 'Una URL local. La URL debe ser relativa a la página del tema y no puede contener nombre de servidor o protocolo, los enlaces van precedidos de “%s”',
		'RELATIVE_URL'	=> 'Una URL relativa. Tu puedes utilizar esto para que coincida con las partes de una URL, pero tenga cuidado: una URL completa es una URL relativa válida. Cuando se desea utilizar URLs relativas de su foro, utilice la ficha LOCAL_URL',
...
$lang = array_merge($lang, array(
	...
	'NO_SMILIES_EXPORT'	=> 'No tienes emoticones con los cuales puedas crear un paquete.',
	...
	'SMILIES_CONFIG'			=> 'Configuración de emoticonds',
	...
	'SMILIES_HEIGHT'			=> 'Altura del emoticono',
	'SMILIES_IMAGE'				=> 'Imagen del emoticono',
	...
	'SMILIES_URL'				=> 'Archivo del emoticono',
	'SMILIES_WIDTH'				=> 'Ancho del emoticono',
...
$lang = array_merge($lang, array(
	...
	'DISALLOWED_ALREADY'		=> 'El nombre que ingresaste se encuentra deshabilitado.',
