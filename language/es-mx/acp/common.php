...
$lang = array_merge($lang, array(
	...
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Aquí puedes ver la lista y eliminar los ficheros adjuntos de los mensajes, y los mensajes privados.',
	...
	'ADM_LOGGED_OUT'		=> 'Te desconectaste con éxito del Panel de Control de Administración (PCA)',
	...
	'LOGIN_ADMIN'			=> 'Para Administrar el Foro debes de ser un usuario identificado.',
	'LOGIN_ADMIN_CONFIRM'	=> 'Para Administrar el Foro debes de introducir tu contraseña otra vez.',
	...
	'NO_FILES_TO_DELETE'	=> 'No existen los adjuntos que tu seleccionaste para su eliminación.',
	...
	'PROCEED_TO_ACP'					=> '%sIr al Panel de Administración (ACP)%s',

	'REMIND'							=> 'Recordar',
	'RESYNC'							=> 'Resincronizar',

    'RUNNING_TASK'			=> 'Ejecutando tarea: %s.',
	'SELECT_ANONYMOUS'		=> 'Selecciona usuario anónimo',
...
$lang = array_merge($lang, array(
	...
	'NO_SEARCH_INDEX'	=> 'El motor de búsqueda seleccionado no tiene un índice de búsqueda.<br />Por favor crea el índice “%1$s” en la section  %2$sindice de búsqueda%3$s .',
	...
	'PURGE_CACHE_CONFIRM'	=> '¿Estás seguro que quieres limpiar la caché?',
	...
	'PURGE_SESSIONS_CONFIRM'	=> '¿Estás seguro que quieres purgar todas las sesiones? Esto desconectará a todos los usuarios.',
	...
	'RESET_DATE'					=> 'Reiniciar fecha comienzo Foro',
	'RESET_DATE_CONFIRM'			=> '¿Estás seguro que quieres reiniciar la fecha de comienzo del Sitio?',
	'RESET_DATE_SUCCESS'				=> 'Fecha de inicio del Foro reiniciada',
	'RESET_ONLINE'					=> 'Reiniciar contador usuarios máximos identificados',
	'RESET_ONLINE_CONFIRM'			=> '¿Estás seguro que quieres reiniciar el contador de mayor cantidad de usuarios en línea?',
	...
	'RESYNC_POSTCOUNTS_CONFIRM'		=> '¿Estás seguro que quieres resincronizar la cantidad de mensajes?',
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Resincronizar la cantidad de mensajes',
	'RESYNC_POST_MARKING'			=> 'Sincronizar temas marcados',
	'RESYNC_POST_MARKING_CONFIRM'	=> '¿Estás seguro que quieres resincronizar los temas marcados?',
	...
	'RESYNC_STATS_CONFIRM'			=> '¿Estás seguro que quieres resincronizar las estadísticas?',
	...
	'TIMEZONE_INVALID'	=> 'La zona horaria que has seleccionado no es válida.',
...
'LOG_PRUNE_SHADOW'		=> '<strong>Auto-purgados: temas sombreados</strong><br />» %s',
	...
	'LOG_RESYNC_FILES_STATS'	=> '<strong>Resincronizado: Estadísticas de archivos</strong>',
