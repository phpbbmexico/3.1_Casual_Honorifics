...
'DOWNLOAD_ADD_IPS_EXPLAIN'			=> 'Para especificar varias IPs o hostnames diferentes, introduce cada una en una nueva línea. Para especificar un rango de direcciones IP separa el inicio y el final con un guión (-), para especificar un comodín usa *',
	...
	'FILES_GONE'			=> 'Algunos de los archivos adjuntos que seleccionaste para su eliminación ya no existen. Pueden haber sido eliminados. Los archivos adjuntos que no existen se eliminaron.',
	...
	'RESYNC_FILES_STATS_CONFIRM'	=> '¿Estás seguro que deseas resincronizar las estadísticas de archivos?',
