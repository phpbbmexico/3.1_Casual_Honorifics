...
'ALPHA_PUNCTUATION'		=> 'Alfanumérico con comas, puntos, guiones y guiones que comienza con una letra',
	...
	'DISPLAY_ON_PM'					=> 'Mostrar en la vista de pantalla de MP',
	'DISPLAY_ON_PM_EXPLAIN'			=> 'Si habilitas está opción, el campo será mostrado en el mini-perfil de la pantalla de MP.',
	...
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'Campos de contacto son mostrados  en la sección de contactos del perfil de usuario y se muestran de manera diferente en el mini perfil junto a respuestas y mensajes privados. Puedes usar <samp>%s</samp> como una variable de marcador de posición que será sustituida por un valor proporcionado por el usuario.',
	...
	'REQUIRED_FIELD_EXPLAIN'	=> 'Requiere que el campo del perfil sea rellenado o especificado por el usuario o La Administración. Si la opción de Mostrar en la pantalla de registro está habilitada el campo solo será requerido cuando el usuario edite su perfil.',
	'ROWS'						=> 'Filas',

	'SAVE'							=> 'Guardar',
	'SECOND_OPTION'					=> 'Segunda opción',
	'SHOW_NOVALUE_FIELD'			=> 'Mostrar el campo si no hay ningún valor seleccionado.',
	'SHOW_NOVALUE_FIELD_EXPLAIN'	=> 'Determina si el campo de perfíl se debe mostrar si no fue seleccionado un valor para los campos opcionales, o si no ha seleccionado un valor aún para los campos obligatorios.',
	...
	'STEP_2_EXPLAIN_EDIT'			=> 'Aquí puedes cambiar algunas opciones comunes. Más adelante puedes hacer una vista previa de los cambios, tal como lo vería el usuario. Prueba hasta que quede como usted desees.<br /><strong>Por favor observa que estos cambios no afectarán a los perfiles existentes de los usuarios.</strong>',
	'STEP_2_TITLE_CREATE'			=> 'Opciones específicas del tipo de perfil',
	'STEP_2_TITLE_EDIT'				=> 'Opciones específicas del tipo de perfil',
	'STEP_3_EXPLAIN_CREATE'			=> 'Ya que tienes más de un idioma instalado para el Sitio, debes completar los ítems en los idiomas restantes. EL campo funcionará con el idioma por defecto, puedes completar los idiomas restantes después.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Ya que tienes más de un idioma instalado para el Sitio, debes cambiar los ítems en los idiomas restantes. EL campo funcionará con el idioma por defecto.',
