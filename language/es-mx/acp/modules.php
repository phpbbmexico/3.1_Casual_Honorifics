...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'		=> 'Aquí puedes manejar toda clase de módulos. Por favor observa que el Panel de Administración (ACP) tiene una estructura de menú de tres niveles (Categoría -> SubCategoría -> Módulo) por lo cual los otros tienen una estructura de menú de dos niveles (Categoría -> Módulo) la cual debe ser respetada. Por favor ten en cuenta que puedes bloquearte a ti mismo si deshabilitas o borras el módulo de administración de módulos.',
