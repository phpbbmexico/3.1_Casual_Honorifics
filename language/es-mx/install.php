...
$lang = array_merge($lang, array(
	...
	'ADMIN_PASSWORD_EXPLAIN'	=> 'Por favor introduce una contraseña de entre 6 y 30 caracteres de longitud.',
	'ADMIN_TEST'				=> 'Verificar configuración de administrador',
	'ADMIN_USERNAME'			=> 'Nombre de administrador',
	'ADMIN_USERNAME_EXPLAIN'	=> 'Por favor introduce un nombre de entre 3 y 20 caracteres de longitud.',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Ha convertido su Sitio a phpBB 3.1 correctamente. Ahora puede identificarse y <a href="../">acceder a su Sitio</a>. Recuerde que hay ayuda disponible en línea para usar phpBB3 vía <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Documentación</a>, <a href="https://www.phpbb.com/community/viewforum.php?f=466">foro de soporte</a> (Sitios en inglés).',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '		
		...
		<p>Haciendo clic en el botón de abajo llegará a un formulario para enviar información estadística a phpBB en su Panel de Control de Administración (ACP). Le estaríamos muy agradecidos si pudiera ayudarnos enviándonos esa información. Después podría tomarse algún tiempo para examinar las opciones disponibles para usted. Recuerde que hay disponible ayuda en línea mediante <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">Documentación</a>, <a href="https://www.phpbb.com/community/viewforum.php?f=466">foros de soporte</a> (ambos en inglés), lea el documento <a href="%3$s">LEAME</a> para más información.</p><p><strong>Por favor borre, mueva o renombre la carpeta install antes de usar su Sitio. Si esta carpeta se encuentra presente, solamente el Panel de Administración (ACP) será accesible.</strong>',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'   => 'El schema de su base de datos MySQL para phpBB quedó obsoleto. phpBB detectó un schema para MySQL 3.x/4.x, pero el servidor funciona con MySQL %2$s.<br /><strong>Antes de que proceda a la actualización necesita actualizar el schema.</strong><br /><br />Por favor consulte este artículo (en inglés) <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Knowledge Base article about upgrading the MySQL schema</a>. Si encuentra problemas o no se defiende con el inglés, por favor acuda al <a href="https://www.phpbb.com/community/viewforum.php?f=466">foros de soporte</a> (en inglés).',
...
$lang = array_merge($lang, array(
	...
	'ERROR'			=> 'Error',
	'EVERYTHING_UP_TO_DATE'		=> 'Todos los archivos están actualizados a la última versión de phpBB. Ahora podría <a href="%1$s">identificarse en su foro</a> y verificar si todo funciona bien. ¡No olvide borrar, renombrar o mover la carpeta install! Por favor envíenos información actualizada sobre su servidor y configuración de foro desde el módulo <a href="%2$s">Enviar estadísticas</a>en su ACP.',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> 'Este es un mensaje de ejemplo en su instalación phpBB3. puede borrar este mensaje, este hilo e incluso este foro si quiere, ¡ya que todo parece estar funcionando! Pero es buena idea usar la categoría y el foro creados por defecto para copiar los permisos en los futuros foros a crear. Le simplificará la tarea. ¡Gracias!',
